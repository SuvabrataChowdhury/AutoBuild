  ...
  return (
    ...
    <div className="about-container">
      ...
      <div className="hero">
        ...
        <p className="hero-text">Streamlining processes with intelligence and efficiency.</p>
      </div>
      ...
      <div className="mission-section">
        ...
        <p className="mission-text">
          ...
          project delivery — all while maintaining clean design and user-friendly 
          experiences. We aim to empower teams to focus on innovation rather than 
          manual tasks.
        </p>
      </div>
