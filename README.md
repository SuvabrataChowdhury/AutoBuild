...
![tech stack](./autobuild-docs/architecture/drawio/img/techstack.svg)
...
## Quick Links
1. [Architecture](./autobuild-docs/architecture/architecture.md)
2. [Local Dev Environment Setup](./autobuild-docs/setup/dev-env-setup.md) 
